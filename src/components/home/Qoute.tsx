      ...
      <div className="relative h-[480px]">
        ...
        <PaddingWrapper>
          <div className=" absolute px-4 mt-2  top-[8rem]  max-w-[30rem]">
            <h1 className=" text-white  lg:text-2xl lg:pb-2  text-xl font-light tracking-tight leading-[1.5]">
              The single biggest difference we can make in the developing world
              is to educate and empower women.
            </h1>
            <div>
              <p className="text-primary font-semibold text-2xl">Melinda Gates</p>
